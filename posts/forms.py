...
class SelectionAddForm2(PostBaseForm):
    CATEGORY_CHOICES=[
        ('1','대인관계'),
        ('2','연애'),
        ('3','교육'),
    ...
    selection_content2=forms.CharField(label = '선택지 내용',max_length=20)
    #선택지3
    image3=forms.ImageField(label = '이미지')
    selection_content3=forms.CharField(label = '선택지 내용',max_length=20)
    
    category = forms.ChoiceField(label='카테고리',choices= CATEGORY_CHOICES)
    class Meta(PostBaseForm.Meta):
        fields = ['title','content']
        
class SelectionAddForm3(PostBaseForm):
    CATEGORY_CHOICES=[
        ('1','대인관계'),
        ('2','연애'),
        ('3','교육'),
    ...
    selection_content3=forms.CharField(label = '선택지 내용',max_length=20)
    #선택지4
    image4=forms.ImageField(label = '이미지')
    selection_content4=forms.CharField(label = '선택지 내용',max_length=20)
